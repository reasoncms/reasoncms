...
that you want to use them. If a lookup (or authentication) fails in the first service, it will fall through
to the next, until a success occurs or all have been checked.
