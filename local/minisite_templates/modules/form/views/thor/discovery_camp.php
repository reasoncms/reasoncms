...
$GLOBALS[ '_form_view_class_names' ][ basename( __FILE__, '.php') ] = 'DiscoveryCampThorForm';

class DiscoveryCampThorForm extends CreditCardThorForm
{
	function on_every_time()
	{
		parent::on_every_time();
                ...
                // 5/17/2011
               $this->set_value($revenue_element, '13-000-01808-22000');
               $this->set_value($expense_element, '13-000-01808-12121');
	}
}
?>