...
<form name="redirect3">
    <select id="offices" name="offices" onchange="buildingReset(); departmentReset()">
        ...
        <option value="/">Alumni/Developement</option>
        <option value="/">Archives</option>
        <option value="/">Box Office</option>
        <option value="/">Campus Programming</option>
        <option value="/">Career Center</option>
        <option value="/">Catering</option>
        <option value="/">Chips Newspaper</option>
        <option value="/">College Ministries</option>
        <option value="/">Counseling Service</option>
        <option value="/">Custodial Office</option>
        <option value="/">Deans Office</option>
        <option value="/">Developement Office</option>
        <option value="/">Dining Services</option>
        <option value="/">Diversity Center</option>
        ...
        <option value="/">International Student Coordinate</option>
        <option value="/">KWLC</option>
        <option value="/">Library Information Studies</option>
        <option value="/">Mail Center</option>
        <option value="/">Marty's</option>
        <option value="/">Oneota Market</option>
        <option value="/">President's Office</option>
        <option value="/">Public Information</option>
        <option value="/">Publications</option>
        <option value="/">Registrar's Office</option>
        <option value="/">Residence Life</option>
        <option value="/">Security Office</option>
        <option value="/">Student Academic Support Center</option>
        <option value="/">Student Activities</option>
        <option value="/">Student Life</option>
        <option value="/">Study Abroad Office</option>
        <option value="/">Upward Bound</option>
