...
class norseCalendarModule extends DefaultMinisiteModule {
    ...
    function run() {
        ...
        foreach ($norse_calendar_info as $info) {
            ...
            echo '<iframe src="https://www.google.com/calendar/hosted/luther.edu/embed?height=400&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src='. $info->get_value('name') .'%40luther.edu&amp;color=%23A32929&amp;ctz=America%2FChicago" style=" border-width:0 " width="498" height="400" frameborder="0" scrolling="no"></iframe>';
