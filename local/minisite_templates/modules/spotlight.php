<?php
$GLOBALS[ '_module_class_names' ][ 'spotlight' ] = 'SpotlightModule';
$GLOBALS[ '_module_class_names' ][ basename( __FILE__, '.php' ) ] = 'SpotlightModule';
...
*/	
class SpotlightModule extends Generic3Module
{
////////
// VARIABLES
////////	
