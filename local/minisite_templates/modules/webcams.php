...
class WebcamsModule extends DefaultMinisiteModule
{
  ...
  function run()
  {
      ...
      echo '<a href="https://reasondev.luther.edu/dining/cafcam/"><img src="https://reasondev.luther.edu/images/luther2010/webcams/caf_cam_link.png" width="200" height="150" /></a>';
      echo '</p>';
      echo '<h2>Eagle Cam</h2><p>';
      echo '<a href="http://www.luther.edu/eaglecam/"><img src="https://reasondev.luther.edu/images/luther2010/webcams/eagle_cam_link.png" width="200" height="150" /></a>';
      echo '</p>';
      ...
      echo '<a href="http://mesonet.agron.iastate.edu/data/camera/640x480/KCRG-013.jpg"><img src="https://reasondev.luther.edu/images/luther2010/webcams/weather_cam_link.png" width="200" height="150" /></a>';
      echo '</p>';
      echo '<h2>Olin Cam</h2><p>';
      echo '<a href="http://www.luther.edu/computerscience/olinview/"><img src="https://reasondev.luther.edu/images/luther2010/webcams/olin_cam_link.png" width="200" height="150" /></a>';
      echo '</p>';
