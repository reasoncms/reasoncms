...
class MobileIconHomeModule extends DefaultMinisiteModule {
    ...
    function run() {
        ...
        echo '<a accesskey="4" href="https://find.luther.edu/">Find</a>';
        echo '</li>';
        echo '<li id="menu-map">';
        echo '<a accesskey="5" href="https://reasondev.luther.edu/mobile/map/">Campus Map</a>';
        echo '</li>';
        echo '<li id="menu-directions">';
        echo '<a accesskey="6" href="http://reasondev.luther.edu/mobile/directions/">Directions</a>';
        echo '</li>';
        echo '<li id="menu-directory">';
        echo '<a accesskey="7" href="http://www.luther.edu/mobile/directory/">Directory</a>';
        echo '</li>';
        echo '<li id="menu-labstat">';
        echo '<a accesskey="8" href="http://reasondev.luther.edu/mobile/labs/">Lab Availability</a>';
        echo '</li>';
        echo '<li id="menu-library_search">';
        echo '<a accesskey="9" href="http://reasondev.luther.edu/mobile/librarysearch/">Library Search</a>';
        echo '</li>';
        echo '<li id="menu-news">';
        echo '<a accesskey="10" href="http://reasondev.luther.edu/mobile/news/">News</a>';
        echo '</li>';
