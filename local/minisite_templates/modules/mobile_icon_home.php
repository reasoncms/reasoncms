...
class MobileIconHomeModule extends DefaultMinisiteModule {
    ...
    function run() {
        ...
        echo '<a accesskey="3" href="http://reasondev.luther.edu/mobile/labs/">Available Computers</a>';
        echo '</li>';
        echo '<li id="menu-cafcam">';
        echo '<a accesskey="4" href="https://reasondev.luther.edu/mobile/comingsoon/">Caf Cam</a>';
        echo '</li>';
        echo '<li id="menu-map">';
        echo '<a accesskey="5" href="https://reasondev.luther.edu/mobile/comingsoon/">Campus Map</a>';
        echo '</li>';
