<?php
	...
	class twitterModule extends DefaultMinisiteModule
	{
		...
		function run()
		{
			...
			echo '<script>'."\n";
			echo 'new TWTR.Widget({profile: true,id: \'twtr-profile-widget\',loop: true,width: 239,height: 300,theme:{shell: {background: \'#ffffff\',color: \'#99aacc\'},tweets: {background: \'#ffffff\',color: \'#444444\',links: \'#1985b5\'}}}).render().setProfile(\'lutherultimate\').start();	</script>';
		}
	}
?>
