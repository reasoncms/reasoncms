...
function admissions_main_navigation()
{
        ...
        echo '<li class="fastFacts"><a href="/admissions/fastfacts/">Fast Facts</a>'."\n";
        	...
        	echo '<li><a href="/admissions/fastfacts/profilefirstyear/">Profile of 2012 Class</a></li>'."\n";
        	echo '<li><a href="/admissions/fastfacts/decorah/">Decorah Area</a></li>'."\n";
        	echo '<li><a href="/admissions/fastfacts/aboutluther/">Luther at a Glance</a></li>'."\n";
        ...
        echo '<li class="academics"><a href="/admissions/academics/">Academics</a>'."\n";
        	echo '<ul>'."\n";
        	echo '<li><a href="/admissions/academics/academiccalendar/">Academic Calendars</a></li>'."\n";
        	...
        	echo '<li><a href="/admissions/academics/lis/">Library and Information Services</a></li>'."\n";
        ...
        echo '<li class="lifeAtLuther"><a href="/admissions/lifeatluther/">Life at Luther</a>'."\n";
        	...
        	echo '<li><a href="/admissions/lifeatluther/health/">Health Service</a></li>'."\n";
        	echo '<li><a href="/admissions/lifeatluther/wellnessprogram/">Wellness Program</a></li>'."\n";
        	echo '<li><a href="/admissions/lifeatluther/studentactivities/">Student Activities and Organizations</a></li>'."\n";
        	echo '</ul></li>'."\n";
