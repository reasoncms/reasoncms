...
function admissions_main_navigation()
{
        ...
        echo '<li class="fastFacts"><a href="/admissions/fastfacts/">Fast Facts</a>'."\n";
        	echo '<ul>'."\n";
        	echo '<li><a href="http://www.luther.edu/about/facts/">Quick Facts</a></li>'."\n";
        	...
        	echo '<li><a href="http://www.luther.edu/sasc/">Student Academic Support Center</a></li>'."\n";
        ...
        echo '<li class="lifeAtLuther"><a href="/admissions/lifeatluther/">Life at Luther</a>'."\n";
        	...
        	echo '<li><a href="http://www.luther.edu/ministries/">College Ministries</a></li>'."\n";        	
        	echo '<li><a href="http://www.luther.edu/diversity/">Diversity Center</a></li>'."\n";
        	echo '<li><a href="/reslife/">Residence Life</a></li>'."\n";
        	echo '<li><a href="https://www.luther.edu/dining/">Dining Services</a></li>'."\n";
        	echo '<li><a href="http://www.luther.edu/counseling/">Counseling Service</a></li>'."\n";
        	echo '<li><a href="http://www.luther.edu/recsports/">Recreational Services</a></li>'."\n";
        	echo '<li><a href="http://www.luther.edu/studentlife/wellness/">Wellness Program</a></li>'."\n";
        	echo '<li><a href="http://www.luther.edu/healthservice/">Health Service</a></li>'."\n";
        	echo '<li><a href="http://www.luther.edu/safety/">Safety & Security</a></li>'."\n";
        	echo '<li><a href="http://www.luther.edu/studentlife/activities/">Student Activities & Organizations</a></li>'."\n";
        	echo '</ul></li>'."\n";
