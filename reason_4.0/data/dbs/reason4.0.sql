...
CREATE TABLE `chunk` (
  ...
  `content` text,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240517 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `entity` (
  ...
  KEY `state` (`state`)
) ENGINE=MyISAM AUTO_INCREMENT=240531 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
INSERT INTO `ldap_cache` VALUES (5,'','','0000-00-00 00:00:00',''),(75393,'admin','webmaster@carleton.edu','2011-07-06 15:35:10','admin'),(240492,' ','webmaster@carleton.edu','2008-09-24 18:10:11','admin');
...
CREATE TABLE `relationship` (
  ...
  KEY `type_index` (`type`)
) ENGINE=MyISAM AUTO_INCREMENT=559746 DEFAULT CHARSET=utf8;
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2011-07-06 20:38:33
