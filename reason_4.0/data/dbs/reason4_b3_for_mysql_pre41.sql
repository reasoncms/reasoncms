...
) ENGINE=MyISAM AUTO_INCREMENT=384 ;
...
CREATE TABLE `chunk` (
  ...
  `content` text,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240350 ;
...
CREATE TABLE `dated` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240344 ;
...
CREATE TABLE `display_name` (
  ...
  `display_name` tinytext,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=238660 ;
...
CREATE TABLE `entity` (
  ...
  KEY `state` (`state`)
) ENGINE=MyISAM AUTO_INCREMENT=240412 ;
...
CREATE TABLE `newstype` (
  ...
  `author_description` varchar(255) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240315 ;
...
CREATE TABLE `relationship` (
  ...
  KEY `type_index` (`type`)
) ENGINE=MyISAM AUTO_INCREMENT=559482 ;
...
CREATE TABLE `show_hide` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240346 ;
...
CREATE TABLE `sortable` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240388 ;
