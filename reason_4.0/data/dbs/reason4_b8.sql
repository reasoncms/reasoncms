...
INSERT INTO `admin_link` VALUES (38,'true'),(3486,'true'),(3496,'true'),(3497,'true'),(3498,'true'),(3501,'true'),(17685,'true'),(34442,'true'),(81327,'true'),(109269,'true'),(221355,'true'),(221357,'true'),(221359,'true'),(221365,'true'),(221372,'true'),(240451,'true'),(240452,'true'),(240506,''),(240507,''),(240508,'');
...
CREATE TABLE `chunk` (
  ...
  `content` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240512 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `display_name` (
  ...
  `display_name` tinytext,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240511 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `display_name` VALUES (3250,'Default View'),(3251,'List'),(3468,'List'),(3989,'Default'),(6301,'List'),(7435,'Tree'),(156572,'Default'),(140154,'Default'),(9440,'List'),(119825,'Default'),(27787,'List'),(22126,'list'),(22039,'List'),(13860,'Tree'),(13861,'List'),(14014,''),(14423,'list'),(35398,'Default Listing'),(36806,''),(57366,'Standard'),(240459,'List'),(240510,'Sections and Issues');
...
INSERT INTO `external_css` VALUES (9406,'true'),(195066,'true'),(195069,'true'),(240387,'true'),(240418,'true'),(240420,'true'),(240422,'true'),(240424,'true'),(240426,'true'),(240428,'true'),(240430,'true'),(240432,'true'),(240479,'true'),(240505,'');
...
INSERT INTO `ldap_cache` VALUES (5,'','','0000-00-00 00:00:00',''),(75393,'admin','webmaster@carleton.edu','2010-04-07 16:54:25','admin'),(240492,' ','webmaster@carleton.edu','2008-09-24 18:10:11','admin');
...
CREATE TABLE `relationship` (
  ...
  KEY `type_index` (`type`)
) ENGINE=MyISAM AUTO_INCREMENT=559708 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sortable` VALUES (3250,11),(3251,10),(3468,12),(3989,14),(38,NULL),(3486,NULL),(3496,NULL),(3497,NULL),(3498,NULL),(3501,NULL),(6301,35),(7435,15),(9406,9),(9440,27),(13860,39),(13861,40),(14014,16),(14423,17),(17685,NULL),(240344,32767),(22039,9),(22126,38),(27787,1),(34442,NULL),(35398,5),(36806,6),(57366,43),(75394,32767),(81327,32767),(109269,32767),(119825,32767),(140154,32767),(156572,32767),(195066,32767),(195069,32767),(221355,32767),(221357,32767),(221359,32767),(221365,32767),(221372,32767),(240355,32767),(240356,32767),(240357,32767),(240358,32767),(240359,32767),(240360,32767),(240361,32767),(240362,32767),(240387,32767),(240418,32767),(240420,32767),(240422,32767),(240424,32767),(240426,32767),(240428,32767),(240430,32767),(240432,32767),(240448,32767),(240449,32767),(240450,32767),(240451,0),(240452,0),(240459,32767),(240479,32767),(240490,32767),(240505,9),(240506,32767),(240507,32767),(240508,32767),(240510,32767),(240512,32767);
...
-- Dump completed on 2010-04-07 23:19:28
