...
INSERT INTO `admin_link` VALUES (38,'true',NULL),(3486,'true',NULL),(3496,'true',NULL),(3497,'true',NULL),(3498,'true',NULL),(3501,'true',NULL),(17685,'true',NULL),(34442,'true',NULL),(81327,'true',NULL),(109269,'true',NULL),(221355,'true',NULL),(221357,'true',NULL),(221359,'true',NULL),(221365,'true',NULL),(221372,'true',NULL),(240451,'true',NULL),(240452,'true',NULL),(240506,'',NULL),(240507,'',NULL),(240508,'',NULL),(240533,NULL,NULL);
...
CREATE TABLE `allowable_relationship` (
  ...
  `type` enum('owns','borrows','archive','association') NOT NULL DEFAULT 'association',
  PRIMARY KEY (`id`),
  KEY `name_index` (`name`),
...
INSERT INTO `allowable_relationship` VALUES (1,1,2,'Type to table relationship.  This type of association specifies which tables to use with which types.','type_to_table','many_to_many','','Choose Entity Tables','no','Types that use this table','unidirectional','Types that use this table','no','association'),(2,3,1,'Site to Content Type - Which content types show up on which sites.','site_to_type','many_to_many','','Select available type(s)','no','Assign to site(s)','bidirectional','Sites that have access to this type','no','association'),(3,3,4,'Site to User - which users belong to which sites.','site_to_user','many_to_many','','Users','no','Sites to which this user has access','bidirectional','Sites to which this user has access','no','association'),(4,3,1,'site ownership of type data','site_owns_type','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(5,3,4,'site ownership of user data','site_owns_user','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(11,3,36,'site owns admin link','site_owns_admin_link','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(8,3,36,'site to admin link','site_to_admin_link','many_to_many','','Admin links','no','Assign to site(s)','bidirectional','Sites with this admin link','no','association'),(9,3,2,'site owns entity table','site_owns_content_table','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(10,3,3,'site owns site data','site_owns_site','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(60,2812,2785,'view types associated with views','view_to_view_type','many_to_many','','View Type','no','views that use this view type','unidirectional','views that use this view type','no','association'),(57,3,2785,NULL,'site_owns_view_type','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(21,3,88,NULL,'site_owns_news','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(41,88,243,'Images associated with a news story','news_to_image','many_to_many','','Associate images with this post','no','Assign to news post(s)','bidirectional','News posts that use this image','yes','association'),(36,3,243,NULL,'site_owns_image','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(59,3,2812,NULL,'site_owns_view','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(61,2812,3,'Associate views to sites','view_to_site','many_to_many','','Assign to site(s)','no','Select available view(s)','bidirectional','Views that this site uses','no','association'),(62,2812,1,'Associate types with views','view_to_type','many_to_many','','Type','no','Views that use this type','unidirectional','Views that use this type','no','association'),(63,3,2820,NULL,'site_owns_field','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(64,3,2823,NULL,'site_owns_project','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(65,2812,2820,'Columns to be show in a view','view_columns','many_to_many','','','no','Views that use this field as a column','unidirectional','Views that use this field as a column','no','association'),(66,2812,2820,'Searchable Fields of a View','view_searchable_fields','many_to_many','','Searchable Fields','no','Views that allow searching on this field','unidirectional','Views that allow searching on this field','no','association'),(67,2820,2,'Link fields to their entity table.','field_to_entity_table','one_to_many','','Add to an Entity Table','no','Fields that are part of this table','unidirectional','Fields that are part of this table','no','association'),(74,3,3311,NULL,'site_owns_css','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(75,3,3313,NULL,'site_owns_minisite_template','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(78,3,3317,NULL,'site_owns_minisite_page','many_to_one','',NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(79,3317,243,'Associate Minisite Pages with Images','minisite_page_to_image','many_to_many','','Place images on this page','no','Pages that use this image','unidirectional','Pages that use this image','yes','association'),(80,3317,3317,'minisite page hierarchy stuff','minisite_page_parent','one_to_many','parent_tree','Parent Page','yes','Children Pages','unidirectional','Children Pages','no','association'),(81,3,3379,NULL,'site_owns_text_blurb','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(82,3317,3379,'Association between pages and pulled quotes / text snippets','minisite_page_to_text_blurb','many_to_many','','Place Blurbs','no','Place on Pages','bidirectional','On Pages','yes','association'),(384,3,240412,NULL,'site_owns_external_url','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(84,3,3311,'Link CSS to Sites','site_to_css','many_to_many','hide this relationship from the Reason Admin','CSS Files','no','Sites that use this css','unidirectional','Sites that use this css','no','association'),(85,3,3861,NULL,'site_owns_av','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(86,3,3871,NULL,'site_owns_av_file','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(87,3861,3871,'Media Work has AV File as part or format','av_to_av_file','many_to_many','','Media Files','no','Media Works','unidirectional','Media Works this Media File is part of','yes','association'),(89,3,4264,NULL,'site_owns_user_role','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(90,4,4264,'User to Role','user_to_user_role','many_to_many','','User Roles','no','Users that have this role','unidirectional','Users that have this role','no','association'),(94,2823,243,'project to image','project_to_image','many_to_many','','Images','no','Projects that use this image','unidirectional','Projects that use this image','no','association'),(96,3,5397,NULL,'site_owns_faculty_staff','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(97,3,1,'Site Shares Type','site_shares_type','many_to_many','','Shared types','no','Sites that share this type','unidirectional','Sites that share this type','no','association'),(98,3,1,'site borrows Type','site_borrows_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(99,3,2,'site borrows Entity Table','site_borrows_content_table','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(100,3,3,'site borrows Site','site_borrows_site','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(101,3,4,'site borrows User','site_borrows_user','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(102,3,36,'site borrows Admin Link','site_borrows_admin_link','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(106,3,2785,'site borrows View Type','site_borrows_view_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(107,3,88,'site borrows News','site_borrows_news','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(116,3,243,'site borrows Image','site_borrows_image','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(120,3,2812,'site borrows View','site_borrows_view','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(121,3,2820,'site borrows Field','site_borrows_field','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(122,3,2823,'site borrows Project','site_borrows_project','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(125,3,3861,'site borrows Audio / Video','site_borrows_av','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(126,3,3311,'site borrows External CSS Url','site_borrows_css','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(127,3,3313,'site borrows Minisite Template','site_borrows_minisite_template','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(128,3,3317,'site borrows Page','site_borrows_minisite_page','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(129,3,3379,'site borrows Text Blurb','site_borrows_text_blurb','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(130,3,3871,'site borrows Audio / Video File','site_borrows_av_file','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(131,3,4264,'site borrows User Role','site_borrows_user_role','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(134,3,5397,'site borrows Faculty / Staff','site_borrows_faculty_staff','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(138,3,5890,NULL,'site_owns_policy_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(139,5890,5890,'Policy Archive Relationship','policy_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(140,3,5890,'site borrows Policy','site_borrows_policy_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(141,3,5907,NULL,'site_owns_asset','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(142,5907,5907,'Asset Archive Relationship','asset_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(143,3,5907,'site borrows Asset','site_borrows_asset','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(144,5890,5890,'Policy Heirarchy Relationship','policy_parent','one_to_many','parent_tree','Parent Policy','yes','Policies that have chosen this one as their parent','unidirectional','Policies that have chosen this one as their parent','no','association'),(145,3,6564,NULL,'site_owns_issue_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(146,6564,6564,'Issue Archive Relationship','issue_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(147,3,6564,'site borrows Issue','site_borrows_issue_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(148,88,6564,'News to Issue','news_to_issue','many_to_many','','Assign this story to an issue','no','News items in this issue','unidirectional','News items in this issue','no','association'),(155,88,5907,'News to Asset','news_to_asset','many_to_many','','Make Links to Assets (PDFs, etc.)','no','News items that use this asset','unidirectional','News items that use this asset','no','association'),(156,3313,3311,'minisite template to external css','minisite_template_to_external_css','many_to_many','','','no','Apply to template(s)','bidirectional','Templates that use this CSS','no','association'),(157,5397,243,'Faculty / Staff to Image','faculty_staff_to_image','one_to_many','','Choose Faculty/Staff Photo','no','Faculty/Staff members with this image','unidirectional','Faculty/Staff members with this image','no','association'),(161,3317,3861,'Minisite Page to Media Work','minisite_page_to_av','many_to_many','','Place media on this page','no','Place work on page(s)','bidirectional','Pages this Media Work appears on','yes','association'),(162,3,13993,NULL,'site_owns_bug','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(163,13993,13993,'Bug Archive Relationship','bug_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(164,3,13993,'site borrows Bug','site_borrows_bug','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(172,3317,5890,'Page to Policy','page_to_policy','many_to_many','','Policies','no','Page(s) on which this policy appears','unidirectional','Page(s) on which this policy appears','no','association'),(180,3,27618,NULL,'site_owns_minutes_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(181,27618,27618,'minutes Archive Relationship','minutes_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(182,3,27618,'site borrows minutes','site_borrows_minutes_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(187,3,31512,NULL,'site_owns_event_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(188,31512,31512,'Event Archive Relationship','event_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(189,3,31512,'site borrows Event','site_borrows_event_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(190,3,31518,NULL,'site_owns_category_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(191,31518,31518,'Category Archive Relationship','category_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(192,3,31518,'site borrows Category','site_borrows_category_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(193,31512,31518,'Event to Event Category','event_to_event_category','many_to_many','','Select Categories','yes','Events in this category','unidirectional','Events in this category','no','association'),(194,3,32296,NULL,'site_owns_news_section_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(195,32296,32296,'News Section Archive Relationship','news_section_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(196,3,32296,'site borrows News Section','site_borrows_news_section_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(197,88,32296,'News to News Section','news_to_news_section','many_to_many','','Assign to a News Section','no','News in this news section','unidirectional','News in this news section','no','association'),(198,3317,5907,'Page to Asset','page_to_asset','many_to_many','','Make Links to Assets (PDFs, etc.)','no','Pages on which this asset appears','bidirectional','Pages on which this asset appears','yes','association'),(199,88,31518,'News to Category','news_to_category','many_to_many','','Assign to Categories','no','News items in this category','bidirectional','News items in this category','no','association'),(200,3,33122,NULL,'site_owns_non_reason_site_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(201,33122,33122,'Non-Reason Site Archive Relationship','non_reason_site_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(202,3,33122,'site borrows Non-Reason Site','site_borrows_non_reason_site_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(207,6564,5907,'Issue to Asset','issue_to_asset','many_to_many','','Associate PDFs with this issue','no','Issues with which this asset is associated','unidirectional','Issues with which this asset is associated','no','association'),(214,3,41963,NULL,'site_owns_job','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(215,41963,41963,'Job Archive Relationship','job_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(216,3,41963,'site borrows Job','site_borrows_job','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(218,3,44321,NULL,'site_owns_form','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(219,44321,44321,'Form Archive Relationship','form_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(220,3,44321,'site borrows Form','site_borrows_form','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(221,3317,44321,'Associate Minisite Pages with Forms','page_to_form','many_to_many','','Associate a form with this page','no','Pages that use this form','unidirectional','Pages that use this form','no','association'),(235,3,54388,NULL,'site_owns_office_department_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(236,54388,54388,'Office/Department Archive Relationship','office_department_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(237,3,54388,'site borrows Office/Department','site_borrows_office_department_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(239,3,1,'Site Cannot Edit Type','site_cannot_edit_type','many_to_many','','Choose types this site cannot edit','no','Keep sites from editing this type','bidirectional','Sites that cannot edit this type','no','association'),(244,54388,31518,'office department to category','office_department_to_category','many_to_many','','Is Related To Topic / Category','no','Is Related To Office / Department','bidirectional','Offices/Depts in this category','no','association'),(245,13993,13993,'Task depends on Task','task_depends_on_task','many_to_many','','Tasks that must be completed for this task to be addressed','no','Tasks that depend on this task','unidirectional','Tasks that depend on this task','no','association'),(246,13993,2823,'bug to project','bug_to_project','many_to_many','','','no','Tasks that are part of this project','unidirectional','Tasks that are part of this project','no','association'),(247,41963,54388,'Job to Office/Department','job_to_office_department','many_to_many','','Office/Department(s)','no','Job postings for this office/department','unidirectional','Job postings for this office/department','no','association'),(248,1,2812,'Determines the default views for a particular type','type_to_default_view','many_to_many','','Default Views','no','Types that use this as a default view','unidirectional','Types that use this as a default view','no','association'),(249,31512,243,'Event to Image','event_to_image','many_to_many','','Images','no','Events that use this image','unidirectional','Events that use this image','yes','association'),(250,2823,54388,'identifies which office(s)/dept(s) are clients of a particular project','project_to_client_office_dept','many_to_many','','Clients','no','Projects of which this office/department is a client','unidirectional','Projects of which this office/department is a client','no','association'),(251,3,3,'Parent Site','parent_site','many_to_many','','Parent Site','no','Children Sites','unidirectional','Children Sites','no','association'),(252,3,60241,NULL,'site_owns_faq_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(253,60241,60241,'FAQ Archive Relationship','faq_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(254,3,60241,'site borrows FAQ','site_borrows_faq_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(255,60241,31518,'FAQ categorization','faq_to_category','many_to_many','','Assign to categories','no','FAQs that are assigned to this category','unidirectional','FAQs that are assigned to this category','no','association'),(262,3317,31518,'Page to Category relationship','page_to_category','many_to_many','','Choose Categories','no','Pages assigned to this category','unidirectional','Pages assigned to this category','yes','association'),(269,3,75398,NULL,'site_owns_site_user_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(270,75398,75398,'Site User Archive Relationship','site_user_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(271,3,75398,'site borrows Site User','site_borrows_site_user_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(272,3317,75398,'Page to User','page_to_site_user','many_to_many','','Assign Users that can edit this page','no','Page(s) this user can edit','unidirectional','Page(s) this user can edit','no','association'),(275,3,118606,NULL,'site_owns_project_type_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(276,118606,118606,'Project Type Archive Relationship','project_type_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(277,3,118606,'site borrows Project Type','site_borrows_project_type_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(278,2823,118606,'Project to Project Type','project_to_project_type','many_to_many','','Project Type','yes','Projects','unidirectional','Projects','no','association'),(279,2823,5907,'Project to asset','project_to_asset','many_to_many','','Assets','','Projects associated with this asset','unidirectional','Projects associated with this asset','no','association'),(283,3861,243,'Audio/Video to primary image','av_to_primary_image','one_to_many','','Choose image','no','Audio/Video items that use this as their primary image','unidirectional','Audio/Video items that use this as their primary image','no','association'),(299,3,136617,NULL,'site_owns_site_type_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(300,136617,136617,'Site Type Archive Relationship','site_type_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(301,3,136617,'site borrows Site Type','site_borrows_site_type_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(302,3,136617,'site_to_site_type','site_to_site_type','many_to_many','','Site To Site Type','yes','Sites which are of this site type','bidirectional','Sites which are of this site type','no','association'),(303,33122,136617,'non-reason site to site type','non_reason_site_to_site_type','many_to_many','','Choose site type','yes','Non-Reason sites that are of this site type','unidirectional','Non-Reason sites that are of this site type','no','association'),(304,3,153392,NULL,'site_owns_publication_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(305,153392,153392,'Blog / Publication Archive Relationship','publication_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(306,3,153392,'site borrows Blog','site_borrows_publication_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(307,3,153394,NULL,'site_owns_comment_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(308,153394,153394,'Comment Archive Relationship','comment_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(309,3,153394,'site borrows Comment','site_borrows_comment_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(310,3,153396,NULL,'site_owns_group_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(311,153396,153396,'Group Archive Relationship','group_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(312,3,153396,'site borrows Group','site_borrows_group_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(313,3317,153392,'Place a blog / publication','page_to_publication','one_to_many','','Place a blog / publication','no','Pages where this blog / publication has been placed','unidirectional','Pages where this blog / publication has been placed','no','association'),(314,88,153392,'News is part of blog / publication','news_to_publication','many_to_many','','Post this news item to a blog / publication','no','Manage Posts','bidirectional','Posts on this blog / publication','no','association'),(315,88,153394,'News item has comment','news_to_comment','many_to_many','','Comments made to this post','no','Post(s)','unidirectional','Post(s)','no','association'),(316,153392,153396,'publication to authorized posting group (i.e. who can post)','publication_to_authorized_posting_group','one_to_many','','Who is allowed to post?','yes','Blogs / Publications use this group to determine posting permissions','unidirectional','Blogs / Publications use this group to determine posting permissions','no','association'),(317,153392,153396,'publication to authorized commenting group (i.e. who can comment)','publication_to_authorized_commenting_group','one_to_many','','Who can comment?','yes','Blogs / Publications use this group to determine commenting permissions','unidirectional','Blogs / Publications use this group to determine commenting permissions','no','association'),(318,3,161656,NULL,'site_owns_theme_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(319,161656,161656,'Theme Archive Relationship','theme_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(320,3,161656,'site borrows Theme','site_borrows_theme_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(321,161656,243,'Primary Theme Image','theme_to_primary_image','one_to_many','','Primary Image','no','Theme(s)','unidirectional','Theme(s) that use this image as their primary image','no','association'),(322,161656,3311,'Theme uses CSS files','theme_to_external_css_url','many_to_many','','CSS Files','no','Apply to theme(s)','bidirectional','Themes that use this CSS file','no','association'),(323,3,161656,'Site theme selection','site_to_theme','one_to_many','','Choose a theme','yes','Sites that use this theme','unidirectional','Sites','no','association'),(324,136617,161656,'Themes available to site type','site_type_to_theme','many_to_many','','Themes available to sites of this type','no','Select site types that can choose this theme','bidirectional','Site types that can use this theme','no','association'),(325,161656,3313,'Theme uses template','theme_to_minisite_template','one_to_many','','Choose a template','yes','Themes that use this template','unidirectional','Themes','no','association'),(326,3,161656,'Site theme history','site_has_had_theme','many_to_many','','Theme History','no','Add to sites\' theme history','bidirectional','Sites that have had this theme','no','association'),(327,3,182075,NULL,'site_owns_registration_slot_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(328,182075,182075,'Registration Slot Archive Relationship','registration_slot_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(329,3,182075,'site borrows Registration Slot','site_borrows_registration_slot_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(330,31512,182075,'event type  to  registration slot type','event_type_to_registration_slot_type','many_to_one','','Add registration slots to this event','no','','unidirectional','','no','association'),(331,44321,153396,'Form to authorized viewing group (who can see the form)','form_to_authorized_viewing_group','one_to_many','','Choose group that can fill out the form','no','','unidirectional','','no','association'),(332,44321,153396,'Form to authorized result viewing group (who can see ALL results)','form_to_authorized_results_group','one_to_many','','Choose group that can see all results','no','','unidirectional','','no','association'),(333,88,243,'News to Teaser Image','news_to_teaser_image','one_to_many','','Associate Teaser Image','no','','unidirectional','','no','association'),(334,3317,3317,'Page Archive Relationship','minisite_page_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(335,3379,3379,'Text Blurb Archive Relationship','text_blurb_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(336,1,1,'Type Archive Relationship','type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(337,36,36,'Admin Link Archive Relationship','admin_link_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(338,88,88,'News / Post Archive Relationship','news_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(339,3,3,'Site Archive Relationship','site_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(342,2823,2823,'Project Archive Relationship','project_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(343,5397,5397,'Faculty / Staff Archive Relationship','faculty_staff_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(346,243,243,'Image Archive Relationship','image_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(349,3871,3871,'Audio / Video File Archive Relationship','av_file_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(352,2785,2785,'View Type Archive Relationship','view_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(353,3861,3861,'Audio / Video Archive Relationship','av_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(354,3313,3313,'Minisite Template Archive Relationship','minisite_template_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(355,3311,3311,'External CSS Url Archive Relationship','css_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(357,4,4,'User Archive Relationship','user_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(361,4264,4264,'User Role Archive Relationship','user_role_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(362,2,2,'Entity Table Archive Relationship','content_table_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(363,2820,2820,'Field Archive Relationship','field_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(364,2812,2812,'View Archive Relationship','view_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(365,243,31518,'image is part of category','image_to_category','many_to_many','','Assign to categories','no','Images','bidirectional','Images that are assigned to this category','no','association'),(366,3,3379,'Selects announcement blurb shown across entire site','site_to_announcement_blurb','many_to_many','','Announcement blurb(s)','no','Assign as announcement on sites','bidirectional','Assigned to these sites as an announcement','no','association'),(368,5907,153396,'Asset Access Permissions to Group','asset_access_permissions_to_group','one_to_many','','Limit access to this asset to a group','no','','unidirectional','','no','association'),(373,3,240350,NULL,'site_owns_audience_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(374,240350,240350,' Audience Archive Relationship','audience_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(375,3,240350,'site borrows Audience','site_borrows_audience_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(376,31512,240350,NULL,'event_to_audience','many_to_many',NULL,'Audiences','yes',NULL,'unidirectional',NULL,'no','association'),(377,60241,240350,NULL,'faq_to_audience','many_to_many',NULL,'Audiences','yes',NULL,'unidirectional',NULL,'no','association'),(378,153396,240350,NULL,'group_to_audience','many_to_many',NULL,'Audiences','no',NULL,'unidirectional',NULL,'no','association'),(379,3,240363,NULL,'site_owns_html_editor_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(380,240363,240363,'HTML Editor Archive Relationship','html_editor_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(381,3,240363,'site borrows Editor','site_borrows_html_editor_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(382,3,240363,'site uses html editor','site_to_html_editor','one_to_many',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','association'),(383,4,240350,'user is a member of audience','user_to_audience','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'yes','association'),(385,3,240412,NULL,'site_borrows_external_url','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(386,240412,240412,NULL,'external_url_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(387,3317,240412,'This relationship allows an external URL to be used as the feed source of an RSS parser/displayer','page_to_feed_url','one_to_many',NULL,'Set up feed to display','no',NULL,'unidirectional','Page(s) using this URL as the feed they display','no','association'),(388,6564,153392,'Issue to Publication','issue_to_publication','one_to_many',NULL,'Assign this issue to a publication','no',NULL,'unidirectional',NULL,'no','association'),(389,6564,243,'Issue to Image','issue_to_image','one_to_many',NULL,'Associate an image with this issue','no',NULL,'unidirectional',NULL,'no','association'),(390,6564,3379,'Issue to Text Blurb','issue_to_text_blurb','many_to_many',NULL,'Associate text blurbs with this issue','no',NULL,'unidirectional',NULL,'no','association'),(391,32296,153392,'News Section to Publication','news_section_to_publication','one_to_many',NULL,'Assign this section to a publication','no',NULL,'unidirectional',NULL,'no','association'),(392,32296,243,'News Section to Image','news_section_to_image','one_to_many',NULL,'Associate image with this news section','no',NULL,'unidirectional',NULL,'no','association'),(393,153392,88,'Publication to Featured Post','publication_to_featured_post','many_to_many',NULL,'Featured Posts','no','Feature on Publication(s)','bidirectional','Featured on Publication(s)','yes','association'),(394,31512,88,'Event to News / Post','event_to_news','many_to_many',NULL,'Associate with a News Item','no','Assign to event(s)','bidirectional','Events for this news items','yes','association'),(395,3317,153392,'Attach a related publication','page_to_related_publication','many_to_many',NULL,'Attach a related publication','no','Pages where this publication is a related publication','unidirectional','Pages where this publication is a related publication','yes','association'),(396,6564,240412,'Attaches CSS to a given issue','issue_to_css_url','many_to_many',NULL,'Issue CSS','no',NULL,'unidirectional',NULL,'yes','association'),(397,3,240461,NULL,'site_owns_classified_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(398,3,240461,NULL,'site_borrows_classified_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(399,240461,240461,NULL,'classified_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(400,3,240470,NULL,'site_owns_classified_category_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(401,3,240470,NULL,'site_borrows_classified_category_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(402,240470,240470,NULL,'classified_category_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(403,240461,240470,NULL,'classified_to_classified_category','many_to_many',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','association'),(404,5907,31518,'Asset to Category','asset_to_category','many_to_many',NULL,'Assign to Categories','no','Assets in this category','bidirectional','Assets in this category','yes','association'),(405,3,240471,NULL,'site_owns_quote_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(406,3,240471,NULL,'site_borrows_quote_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(407,240471,240471,NULL,'quote_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(408,3317,240471,'Association between page and quotes','page_to_quote','many_to_many',NULL,'Place Quotes','no','Place on Pages','bidirectional','Pages with this Quote','yes','association'),(409,240471,31518,'Asset to Category','quote_to_category','many_to_many',NULL,'Is About Topic / Category','no','Is Subject of Quote','bidirectional','Quotes in this category','yes','association'),(410,3317,153396,'Limits access to a group','page_to_access_group','one_to_many',NULL,'Restrict Access','no',NULL,'unidirectional','Pages that use this group for access restrictions','no','association'),(411,3,240517,NULL,'site_owns_feature_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(412,3,240517,NULL,'site_borrows_feature_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(413,240517,240517,NULL,'feature_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(414,240517,243,'Feature to Image','feature_to_image','many_to_many',NULL,'Attach Image','no','Add to feature','bidirectional','Features using this image','no','association'),(415,240517,3861,'Feature to Media Work','feature_to_media_work','many_to_many',NULL,'Attach Media Work','no','Add to feature','bidirectional','Features using this media work','no','association'),(416,3317,240517,'Page to Feature','page_to_feature','many_to_many',NULL,'Attach Feature','no','Place feature on page','bidirectional','Featured on pages','yes','association'),(417,5890,153396,NULL,'policy_to_access_group','one_to_many','Content Manager','Access Group','no',NULL,'unidirectional',NULL,'no','association'),(418,5890,240350,NULL,'policy_to_relevant_audience','many_to_many','Content Manager',NULL,'no',NULL,'unidirectional',NULL,'no','association'),(419,5890,54388,NULL,'policy_to_responsible_department','one_to_many',NULL,'Responsible Department','no',NULL,'unidirectional',NULL,'no','association'),(420,3861,153396,'Used for media access control.','av_restricted_to_group','one_to_many','Content Manager','Restricted to Group','no',NULL,'unidirectional',NULL,'no','association'),(421,3,240636,NULL,'site_owns_social_account_type','many_to_one',NULL,NULL,'yes',NULL,'unidirectional',NULL,'no','owns'),(422,3,240636,NULL,'site_borrows_social_account_type','many_to_many',NULL,NULL,'no',NULL,'bidirectional',NULL,'no','borrows'),(423,240636,240636,NULL,'social_account_type_archive','many_to_one',NULL,NULL,'no',NULL,'unidirectional',NULL,'no','archive'),(424,3,240636,'Site to Social Account','site_to_social_account','many_to_many',NULL,'Associate Social Account','no','Associate with Site','bidirectional','Sites using this Social Account','yes','association');
...
CREATE TABLE `av` (
  ...
  `media_format` enum('Quicktime','Windows Media','Real','Flash','MP3','AIFF','Flash Video','HTML5') DEFAULT NULL,
...
CREATE TABLE `blog` (
  ...
  `enable_social_sharing` enum('yes','no') DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chunk` (
  ...
  `content` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240643 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `entity` (
  ...
  PRIMARY KEY (`id`),
  KEY `type_state_index` (`type`,`state`),
  KEY `unique_name_index` (`unique_name`),
...
INSERT INTO `external_css` VALUES (9406,'true',NULL,'','','css/default_styles.css'),(195066,'true',NULL,'A generic three-column layout in css for the tableless2 template; based on the css for the library site.','','css/tableless_layouts/three_column_1.css'),(195069,'true',NULL,'','','css/simplicity/blue.css'),(240387,'true',NULL,NULL,NULL,'css/simplicity/green.css'),(240418,'true',NULL,NULL,NULL,'css/simplicity/tan.css'),(240420,'true',NULL,NULL,NULL,'css/simplicity/grey.css'),(240422,'true',NULL,NULL,NULL,'css/themes/black_box/black_box.css'),(240424,'true',NULL,NULL,NULL,'css/themes/pedagogue/plum.css'),(240426,'true',NULL,NULL,NULL,'css/themes/gemstone/gemstone.css'),(240428,'true',NULL,NULL,NULL,'css/themes/gemstone/ruby/ruby.css'),(240430,'true',NULL,NULL,NULL,'css/themes/gemstone/emerald/emerald.css'),(240432,'true',NULL,NULL,NULL,'css/themes/starbaby/starbaby.css'),(240479,'true',NULL,NULL,NULL,'css/bedrich/bedrich.css'),(240505,'',NULL,'','','/global_stock/css/default_styles.css');
...
CREATE TABLE `form` (
  ...
  `tableless` tinyint(1) DEFAULT '0',
  `submission_limit` int(11) DEFAULT NULL,
...
INSERT INTO `html_editor` VALUES (240367,'loki_2.php'),(240368,'tiny_mce.php');
...
CREATE TABLE `image` (
  ...
  `thumbnail_image_type` tinytext,
  `original_image_type` tinytext,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240343 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `image` VALUES (240342,499,378,9,'gif','','',NULL,NULL);
...
INSERT INTO `ldap_cache` VALUES (5,'','','0000-00-00 00:00:00',''),(75393,'admin','webmaster@domain_name.domain','2013-07-26 16:43:29','admin'),(240492,' ','webmaster@carleton.edu','2008-09-24 18:10:11','admin');
...
CREATE TABLE `media_work` (
  ...
  `av_type` enum('Audio','Video') DEFAULT NULL,
  `media_duration` tinytext,
  `transcoding_status` enum('ready','converting','error') DEFAULT NULL,
  `integration_library` tinytext,
  `tmp_file_name` tinytext,
  `email_notification` tinyint(1) DEFAULT NULL,
  `show_embed` tinyint(1) DEFAULT '1',
  `show_download` tinyint(1) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `meta` (
  ...
  `keywords` tinytext,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=240615 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `meta` VALUES (5,'',''),(240342,'Default Page Locations',''),(4265,NULL,NULL),(40654,'This role limits a user to creating, editing, and deleting pending items. The user cannot affect anything that is considered \"live\" by reason.',''),(46125,'Users with this role will be able to do more web-savvy things than a typical user, such as edit html, upload full-sized images, and things like that.','Power User, Edit HTML, Full-Size Images, Savvy'),(50972,'',''),(75393,'',''),(75394,'',''),(195062,'',''),(240433,NULL,NULL),(240478,NULL,NULL),(240492,'',''),(240614,'','');
...
INSERT INTO `page_node` VALUES (75394,'','','standalone_login_page_stripped','Yes',''),(240614,'','','standalone_login_page_stripped','Yes','');
...
CREATE TABLE `relationship` (
  ...
  PRIMARY KEY (`id`),
  KEY `type_index` (`type`),
  KEY `entity_a_type` (`entity_a`,`type`),
  KEY `entity_b_type` (`entity_b`,`type`)
) ENGINE=MyISAM AUTO_INCREMENT=559980 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `site` VALUES (5,'admin','/masteradmin/','notables','','','asset','Not Live','','master admin needs no url handler!',0,'true','',NULL,NULL,NULL,NULL),(75393,'admin','/login/','default','','','asset','Live','','',0,'true','',NULL,NULL,NULL,NULL),(240492,'admin','/login/','default','','','asset','Live','','',0,'true','','','',NULL,NULL);
...
INSERT INTO `sortable` VALUES (3250,11),(3251,10),(3468,12),(3989,14),(38,NULL),(3486,NULL),(3496,NULL),(3497,NULL),(3498,NULL),(3501,NULL),(6301,35),(7435,15),(9406,9),(9440,27),(13860,39),(13861,40),(14014,16),(14423,17),(17685,NULL),(240344,32767),(22039,9),(22126,38),(27787,1),(34442,NULL),(35398,5),(36806,6),(57366,43),(75394,32767),(81327,32767),(109269,32767),(119825,32767),(140154,32767),(156572,32767),(195066,32767),(195069,32767),(221355,32767),(221357,32767),(221359,32767),(221365,32767),(221372,32767),(240355,32767),(240356,32767),(240357,32767),(240358,32767),(240359,32767),(240360,32767),(240361,32767),(240362,32767),(240387,32767),(240418,32767),(240420,32767),(240422,32767),(240424,32767),(240426,32767),(240428,32767),(240430,32767),(240432,32767),(240448,32767),(240449,32767),(240450,32767),(240451,0),(240452,0),(240459,32767),(240479,32767),(240490,32767),(240505,9),(240506,32767),(240507,32767),(240508,32767),(240510,32767),(240512,32767),(240533,32767),(240535,32767),(240614,32767);
...
INSERT INTO `theme` VALUES (191710,NULL),(195060,NULL),(195065,NULL),(207189,NULL),(240388,NULL),(240417,NULL),(240419,NULL),(240421,NULL),(240423,NULL),(240425,NULL),(240427,NULL),(240429,NULL),(240431,NULL),(240477,NULL);
...
INSERT INTO `url` VALUES (38,'admin/?cur_module=AllowableRelationshipManager'),(2786,'default.php3'),(2787,'tree.php3'),(3486,'scripts/stats/stats.php'),(3496,'scripts/db_maintenance/delete_widowed_relationships.php'),(3497,'scripts/db_maintenance/delete_headless_chickens.php'),(3498,'scripts/db_maintenance/delete_duplicate_relationships.php'),(3501,'scripts/db_maintenance/amputees.php'),(7430,'multiple_root_tree.php'),(17685,'scripts/urls/update_urls.php'),(34442,'scripts/move/move_entities_among_sites.php'),(75394,''),(81327,'scripts/import/import_photos.php'),(109269,'scripts/search/find_across_sites.php'),(124306,'page_tree.php3'),(221355,'scripts/db_maintenance/remove_duplicate_entities.php'),(221357,'scripts/developer_tools/get_page_types.php'),(221359,'scripts/developer_tools/get_type_listers.php'),(221365,'scripts/developer_tools/modules.php'),(221372,'scripts/page_types/view_page_type_info.php'),(240451,'reason/?cur_module=AllowableRelationshipManager'),(240452,'admin/?cur_module=AllowableRelationshipManager'),(240506,'./?cur_module=EntityInfo'),(240507,'./?cur_module=VersionCheck'),(240508,'./?cur_module=ReviewChanges'),(240509,'sections_and_issues.php'),(240533,'?cur_module=AdminTools'),(240536,'list_with_duplicate.php'),(240614,'');
...
-- Dump completed on 2013-07-26 16:48:04
