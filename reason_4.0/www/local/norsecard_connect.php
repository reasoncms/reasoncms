...
group by id_number";
      ...
      $query = "Select tender_name as Tender, sum(transaction_amount) as Balance from norsecard where email like :user and id_number=:patron and transaction_datetime >= STR_TO_DATE(:startDate, '%m/%d/%Y') and transaction_datetime <= STR_TO_DATE(:endDate, '%m/%d/%Y') group by id_number, tender_name";
