/**
 *  This js allows for dynamic switching of video sizes for integrated media works with zencoder.
 *
...
$(document).ready(function() 
{
    ...
    iframe.load(function()
    {
    	if (iframe_height != -1)
    	{
    		...
    		iframe.attr("max-height", iframe_height);
    		iframe.attr("max-width", iframe_width);
    	}
    });
