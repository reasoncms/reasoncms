$(document).ready(function(){
	var galleryItems = $('div.eventDetails .mediaWorks .mediaGallery>li');
	var widest = 100;
	...
	$('div.eventDetails  .mediaWorks .mediaGallery').addClass('galleryActive').before(playingMediaBlock);
	...
	link.click(function(e){
		e.preventDefault();
		listItem = $(this).parents('div.eventDetails .mediaWorks .mediaGallery>li');
