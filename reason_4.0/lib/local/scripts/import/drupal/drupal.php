 ...
 *
 * Imports a drupal site into an existing reason site. Handles the following:
 *
...
// Include the forms
reason_include_once('scripts/import/drupal/SetupForm.php');
reason_include_once('scripts/import/drupal/SetupForm2.php');
reason_include_once('scripts/import/drupal/ReviewForm.php');
...
else
{
	...
	if (isset($_GET['report']))
	{
		...
		echo '<p><a href="'.$link.'">Do another Drupal Import</a></p>';
	...
	else
	{
		...
		$controller->set_data_context('drupal_import');
