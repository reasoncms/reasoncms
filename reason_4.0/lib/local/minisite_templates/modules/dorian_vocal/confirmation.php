...
class ConfirmationForm extends FormStep
{
	...
	function on_every_time()
	{
                ...
                //director info
                $this->directorFirstName = $_SESSION['dorian_vocal_fc_data']['director_first_name'];
                $this->directorLastName = $_SESSION['dorian_vocal_fc_data']['director_last_name'];
                $this->directorEmail = $_SESSION['dorian_vocal_fc_data']['director_email'];
                $this->schoolName = $_SESSION['dorian_vocal_fc_data']['school_name'];
                $this->schoolPhone = $_SESSION['dorian_vocal_fc_data']['school_phone'];
                $this->schoolAddress = $_SESSION['dorian_vocal_fc_data']['school_street_address'];
                $this->schoolCity = $_SESSION['dorian_vocal_fc_data']['school_city'];
                $this->schoolState = $_SESSION['dorian_vocal_fc_data']['school_state'];
                $this->schoolZip = $_SESSION['dorian_vocal_fc_data']['school_zip'];
        ...
        function save_director_info(){
                ...
                connectDB('dorian_vocal_connection');
		...
		$mail = new Email($this->confirmEmailAddress, 'noreply@luther.edu','noreply@luther.edu', 'New Dorian Vocal Registration '.date('mdY H:i:s'),strip_tags($text), $text);
		$mail->send();
                $mail = new Email($this->ccEmailAddress, 'noreply@luther.edu','noreply@luther.edu', 'New Dorian Vocal Registration '.date('mdY H:i:s'),strip_tags($text), $text);
		$mail->send();
