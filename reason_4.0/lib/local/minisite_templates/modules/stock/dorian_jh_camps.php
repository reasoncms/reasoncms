...
function set_confirmation_text($text) {
	connectDB('dorian_jh_camp_connection');
...
function record_transaction($mode = '') {
    ...
    if (array_key_exists('brass_choir_participant', $this->trans_details)) {
	$qstring .= ",
	brass_choir_instrument = '".addslashes($this->trans_details['brass_choir_instrument'])."' ";
    }
