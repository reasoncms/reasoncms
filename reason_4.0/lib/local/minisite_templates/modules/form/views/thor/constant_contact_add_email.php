...
class ConstantContactAddEmail extends DefaultThorForm
{
	...
	var $norseathletics_codes = array(
    ...
    function process()
    {
        ...
        //echo 'email = ' . $email;
        //print_r($keepintouch);
        //print_r($lifeatluther);
        //print_r($norseathletics);
        ...
        else if (preg_match("/^https?:\/\/[A-Za-z0-9_\.]+\/connect\/?/", $url))  // connect site landing page
        {
        	...
        	//add_contact("6ad6b53a-4d71-4495-8c6e-c01c33590864", "TEST", $email);
        }
