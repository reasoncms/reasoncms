 ...
 */
class verboseEventsListItemMarkup extends EventsModule implements eventsListItemMarkup
{
	/**
	 * The function bundle
	 * @var object
	...
	public function get_markup($event, $day, $time)
	{
		...
		{
			$ret .= '<div class="description">'.$event->get_value( 'description' ).'</div>'."\n";
		}
		...
		if($event->get_value( 'location' ))
		{
			...
			//$ret .= '<div class="location">'.$event->get_value( 'location' ).'</div>';
		}
