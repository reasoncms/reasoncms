...
//          'size'=>35,
    ...
    function get_confirmation_text() {
        ...
        if ($this->controller->get('attend_70th_dinner')) {
        ...
        if ($this->controller->get('booklet')) {
            $txt .= '<li><strong>Number of 50 year reunion booklets:</strong> ' . $this->controller->get('booklet') . '</li>' . "\n";
        }
