	...
	class LutherFooterModule extends DefaultMinisiteModule
	{
		...
		function run()
		{
			...
			{	
    			...
    			echo '<nav class="site-info"><ul><li class="about"><a href="http://emergency.luther.edu">Emergency Info</a></li><li class="about"><a href="/privacy/">Privacy Statement</a></li><li class="about"><a href="/contact/">Contact</a></li><li><a href="/reportproblem/">Report a Problem</a></li> </ul></nav>'."\n";
                ...
                if ($this->cur_page->get_value( 'custom_page' ) != 'slate_form'
                    && ($this->cur_page->get_value( 'custom_page') != 'search_results')){
				...
				//echo '<script type="text/javascript" src="/reason/js/jquery.maskedinput-1.3.1.min.js"></script>'."\n";
