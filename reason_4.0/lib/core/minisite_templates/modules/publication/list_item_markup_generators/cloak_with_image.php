...
class CloakWithImageListItemMarkupGenerator extends PublicationMarkupGenerator
{
...
/////
	...
	function get_content_wrapper_markup()
	{
		...
		$markup_string .= '<div class="postInner" data-equalizer-watch>';
			...
			$markup_string .= $this->get_date_title_desc_markup();
		$markup_string .=  '</div>';
	...
	function get_date_title_desc_markup()
	{
		$link_to_full_item = $this->passed_vars['link_to_full_item'];
