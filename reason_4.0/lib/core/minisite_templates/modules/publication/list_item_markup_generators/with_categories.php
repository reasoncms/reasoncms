...
/**
*  A basic post listing page that displays the posts' categories after the publication date.   
*
...
class PublicationWithCategoriesMarkupGenerator extends PublicationMarkupGenerator
{
...
/////
	...
	function get_item_category_markup()
	{
		...
		{
			$link_markup[] = '<li class="post-cat"><a href="' . carl_make_link( array(), '', '', false, false) . $cat->get_value('category_url') . '">' . $cat->get_value('name') . '</a></li>';
		}
