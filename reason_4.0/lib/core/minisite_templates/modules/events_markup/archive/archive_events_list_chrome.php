<?php
/**
 * Events markup class -- Chrome for the archive view's events list
 * @package reason
...
$GLOBALS['events_markup']['minisite_templates/modules/events_markup/archive/archive_events_list_chrome.php'] = 'archiveEventsListChromeMarkup';
/**
 * Class that generates overall chome layout for events module (archive view)
 *
 * This class generates a relatively minimal chrome that does not include any tools for time-based navigation
 * of events.
 */
class archiveEventsListChromeMarkup implements eventsListChromeMarkup
{
	/**
	 * The function bundle
	 * @var object
