...
$GLOBALS['events_markup']['minisite_templates/modules/events_markup/responsive/responsive_hybrid_list_chrome.php'] = 'responsiveHybridEventsListChromeMarkup';
/**
 ...
 * of events.
 */
class responsiveHybridEventsListChromeMarkup implements eventsListChromeMarkup
{
	/**
	 * The function bundle
	 * @var object
