...
$GLOBALS['events_markup']['minisite_templates/modules/events_markup/mini/mini_events_list_ongoing_below.php'] = 'miniEventsListOngoingBelowMarkup';
/**
 * Class that generates a list markup for feed/sidebar display in the the events module
 */
class miniEventsListOngoingBelowMarkup implements eventsListMarkup
{
	/**
	 * The function bundle
	 * @var object
