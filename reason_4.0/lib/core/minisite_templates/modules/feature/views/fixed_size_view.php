...
/**
 * Feature view for fixed-size features (legacy view)
 *
 * @package reason
...
/**
 * This is a feature view that produces fixed-size features. This is the legacy feature view.
 */
class FixedSizeFeatureView extends FeatureView
{
	var $has_av = false;
