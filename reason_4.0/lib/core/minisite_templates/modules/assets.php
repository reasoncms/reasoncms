	...
	class AssetsModule extends DefaultMinisiteModule
	{
		...
		function _display_403_page()
		{
			...
			else
			{
				...
				echo '<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" lang="en-US" xml:lang="en-US"><head><title>403: Forbidden</title></head><body><h1>403: Forbidden</h1><p>You do not have access to this resource.</p></body></html>';
			}
		}
