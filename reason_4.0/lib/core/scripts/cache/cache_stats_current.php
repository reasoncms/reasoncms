<?php
	...
	{
		die('<h1>Sorry.</h1><p>You do not have permission to view current cache stats.</p><p>Only Reason users who have the Administrator role may do that.</p></body></html>');
	}
