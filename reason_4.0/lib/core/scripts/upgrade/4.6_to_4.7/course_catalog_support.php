 ...
 * @subpackage scripts
 */
$GLOBALS['_reason_upgraders']['4.6_to_4.7']['course_catalog_support'] = 'ReasonUpgrader_47_SetupCourseSupport';
...
class ReasonUpgrader_47_SetupCourseSupport implements reasonUpgraderInterface
{
	protected $user_id;
