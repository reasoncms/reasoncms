 ...
 */
$GLOBALS[ '_social_integrator_class_names' ][ basename( __FILE__, '.php' ) ] = 'ReasonEScoresSignupIntegrator';

/**
 * A class that provides ReasonCMS with Escores Signup integration.
 *
 * This is intended to be used as a singleton - obtain it like this:
 *
 * <code>
 * $sih = reason_get_social_integration_helper();
 * $escores_integrator = $sih->get_integrator('escores');
 * </code>
 *
...
class ReasonEScoresSignupIntegrator extends ReasonSocialIntegrator implements SocialAccountProfileLinks
{
	...
	{
		return 'Sign up to recieve sports updates';
	}
	...
	{
		return REASON_HTTP_BASE_PATH . 'modules/social_account/images/escores.png';
	}
	...
	/**
	 * Add / modify for elements for EScores integration.
	 */
	...
	{
		echo '<p>Add/edit an EScores Signup.</p>';
	}
