 ...
 */
$GLOBALS[ '_social_integrator_class_names' ][ basename( __FILE__, '.php' ) ] = 'ReasonStreamingSignupIntegrator';

/**
 * A class that provides ReasonCMS with Streaming Signup integration.
 *
 * This is intended to be used as a singleton - obtain it like this:
 *
 * <code>
 * $sih = reason_get_social_integration_helper();
 * $streaming_integrator = $sih->get_integrator('streaming');
 * </code>
 *
 ...
 * @author Hunter Lynch
 */
class ReasonStreamingSignupIntegrator extends ReasonSocialIntegrator implements SocialAccountProfileLinks, SocialSharingLinks
{
	/****************** SocialAccountProfileLinks implementation ********************/
	public function get_profile_link_text($social_entity_id)
	{
		return 'Sign up for our Streaming Social Account';
	}
	...
	{
		return REASON_HTTP_BASE_PATH . 'modules/social_account/images/streaming-iconV2-green.png';
	}
	...
	/**
	 * Add / modify for elements for Streaming integration.
	 */
	...
	{
		echo '<p>Add/edit an Streaming Signup.</p>';
	}
