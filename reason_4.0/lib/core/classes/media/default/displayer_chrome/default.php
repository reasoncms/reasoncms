...
/**
 * The default media work display chrome.  It only displays the video/audio element. The user can't
 * manually switch video size or anything using this default setup.
 *
 * @author Marcus Huderle
 */
class DefaultDefaultDisplayerChrome implements DisplayerChromeInterface
{
	protected $displayer;
