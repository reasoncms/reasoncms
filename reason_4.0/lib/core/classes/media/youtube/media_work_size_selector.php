...
/**
 * This class generates markup for size selector buttons that are displayed alongside a media
 * work.
 * 
 * @author Marcus Huderle
 */
class YoutubeMediaWorkSizeSelector
{
	/**
	...
	/**
	 * Loads the size_selector's javascript and css for YouTube.
	 *
	 * @param $head_items
	 */
	public function set_head_items($head_items)
	{
		...
		$head_items->add_javascript(REASON_HTTP_BASE_PATH.'media/youtube/size_selector.js');
		$head_items->add_stylesheet(REASON_HTTP_BASE_PATH.'media/youtube/size_selector.css');
	}
}
?>