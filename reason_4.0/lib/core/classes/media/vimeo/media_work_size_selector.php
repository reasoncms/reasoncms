 ...
 */
class VimeoMediaWorkSizeSelector
{
	/**
	...
	/**
	 * Loads the size_selector's javascript and css for Vimeo.
	 *
	 * @param $head_items
	 */
	public function set_head_items($head_items)
	{
		...
		$head_items->add_javascript(REASON_HTTP_BASE_PATH.'media/vimeo/size_selector.js');
		$head_items->add_stylesheet(REASON_HTTP_BASE_PATH.'media/vimeo/size_selector.css');
	}
}
?>