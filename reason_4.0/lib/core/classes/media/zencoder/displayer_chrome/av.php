 ...
 * to display info about the media work.
 *
 * @author Marcus Huderle
 */
class ZencoderAVDisplayerChrome implements DisplayerChromeInterface
{
	protected $displayer;
	protected $shim;
	...
	public function set_head_items($head_items)
	{
		...
		$head_items->add_javascript(REASON_HTTP_BASE_PATH.'media/zencoder/av.js');
		$head_items->add_stylesheet(REASON_HTTP_BASE_PATH.'media/zencoder/av.css');
	}
