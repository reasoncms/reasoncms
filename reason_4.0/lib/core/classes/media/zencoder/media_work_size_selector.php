...
/**
 * Class used for generating size selectors for the video displayer. Shows three clickable buttons
 * corresponding to small, medium, and large video sizes. When clicked, we load the correctly-sized
 * iframe for the media work. Javascript makes the experience dynamic.
 *
 * // TODO: the buttons overlap each other in some older IE versions.
 */ 
class ZencoderMediaWorkSizeSelector
{
	/**
	...
	/**
	 * Loads the size_selector's javascript and css for zencoder.
	 * @param $head_items
	 */
	public function set_head_items($head_items)
	{
		$head_items->add_javascript(JQUERY_URL, true);
		$head_items->add_javascript(REASON_HTTP_BASE_PATH.'media/zencoder/size_selector.js');
		$head_items->add_stylesheet(REASON_HTTP_BASE_PATH.'media/zencoder/size_selector.css');
	}
}
?>