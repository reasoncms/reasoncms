 ...
 */
$GLOBALS[ 'reason_theme_customizers' ][ basename( __FILE__, '.php' ) ] = 'reasonExampleThemeCustomizer';
 ...
 * @author Matt Ryan
 */
class reasonExampleThemeCustomizer implements reasonThemeCustomizerInterface
{
	/**
