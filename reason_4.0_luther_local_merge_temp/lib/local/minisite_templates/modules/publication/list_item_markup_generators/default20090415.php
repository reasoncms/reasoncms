...
*  @author Meg Gibbs
*
*  LUTHER CUSTOMIZATIONS to:
*    function run()
*    function get_links_markup()
*  Pulled Read more... links to end of teaser.
*  Brian Jones, April 2009
*
*/
...
/*	var $markup_methods_to_run = array( 'get_pre_markup',
	...
	function run ()
        // MODIFIED FOR LUTHER PUBLICATION: Brian Jones April 2009 
	{
...
/*		foreach($this->markup_methods_to_run as $method_name)
		...
		$this->markup_string .= $this->get_links_markup();
                $this->markup_string = preg_replace("|\<\/p\>\s?\<\/div\>\s?\<li class\=\"permalink\"\>\s?(\<a href\=\".*?)Permalink\<\/a\>\<\/li\>|", "&nbsp;&nbsp;\\1 Read more...</a></p></div>", $this->markup_string);
